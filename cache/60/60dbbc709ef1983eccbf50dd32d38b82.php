...
<body>
    ";
        // line 11
        $this->loadTemplate("header.twig", "rings.twig", 11)->display($context);
        // line 12
        echo "
...
";
        ...
        <div class=\"card\">
            ...
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ring"], "product_id", [], "any", false, false, false, 19), "html", null, true);
            echo "\"> 
            <img src=\"";
            // line 20
            ...
            echo "</p>
                <a href=\"/public/product.php?id=";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ring"], "product_id", [], "any", false, false, false, 24), "html", null, true);
...
";
    ...
    ";
        // line 34
        $this->loadTemplate("footer.php", "rings.twig", 34)->display($context);
        // line 35
...
";
    ...
    {
        return array (  104 => 35,  102 => 34,  95 => 29,  84 => 24,  80 => 23,  76 => 22,  69 => 20,  65 => 19,  61 => 17,  57 => 16,  51 => 12,  49 => 11,  37 => 1,);
    }
